...
if __name__ == "__main__":
	...
	#       on Imac the GPU is not working. so
		with tf.device('/gpu:2'):
			...
			h_pool13_flat = tf.reshape(h_fc11, [-1, 576])
			...
			y_conv1 = tf.nn.softmax(tf.matmul(h_fc12, W_fc13) + b_fc13)
		...
		#Audio model
			...
			#y_conv4 = kr.layers.Add()([y_conv1, y_conv2])
			y_conv4 = tf.maximum(y_conv1, y_conv2)
